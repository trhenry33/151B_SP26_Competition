...
def run_inference():
    ...
    OUTPUT_PATH = "results/run_inference.jsonl"
    ...
    INPUT_JSONL = "results/run_inference.jsonl"   # change if needed
    OUTPUT_CSV = "run_inference.csv"
    ...
    df = pd.read_csv("run_inference.csv")
    print(df.head())
    print(len(df))
    ...
    INPUT_CSV = "run_inference.csv"
    OUTPUT_CSV = "run_inference_final.csv"
